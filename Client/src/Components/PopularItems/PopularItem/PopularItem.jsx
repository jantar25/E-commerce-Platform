            ...
            <div className='flex-1 flex flex-col bg-[#232B2B] min-w-[280px] h-[400px] m-1 rounded'>
                    ...
                    <div className='h-screen w-screen overflow-auto fixed bottom-0 left-0 right-0 top-0'>
                        ...
                        <div className="h-full flex flex-col items-center justify-center">
                            <h3 className="text-orange-500 text-xl font-[600] text-center">ADDED TO THE CART</h3>
                            <p className="text-white text-sm font-[100] text-center">You may check yours items in your bag</p>
                        </div>
                            )} 
                        </div>             
